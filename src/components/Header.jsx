...
const Header = ({ settingActive, setSettingActive }) => {
    return (
        <header className="fixed w-full backdrop-blur-xl py-1 px-5 z-30  dark:!bg-[rgba(17, 17, 17,0.29)] !bg-[rgba(249, 250, 251,0.30)]">
            <div className=" mx-auto max-w-6xl flex">
                ...
                <button
                    ...
                    className="text-2xl dark:text-white dark:hover:bg-slate-800 active:text-slate-700 outline-none focus:ring-[4px] ring-blue-500 px-[8px] items-center duration-100 hover:bg-slate-300 rounded-md"
                >
                    <AiOutlineSetting />
                </button>
            </div>
